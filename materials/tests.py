...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(
            name="testLesson1", url_video="test_url/youtube.com/test", course=self.course, owner=self.user
        )
        self.lesson_owner = Lesson.objects.create(
            name="testLesson1_owner", url_video="test_url/youtube.com/test", course=self.course, owner=self.owner_user
        )
    ...
    def test_lesson_create(self):
        ...
        data = {"name": "testLesson2", "url_video": "test_url2/youtube.com", "course": self.course.pk}
    ...
    def test_lesson_update(self):
        ...
        data = {"name": "testLesson1update", "url_video": "test_url_update/youtube.com", "course": self.course.pk}
        response = self.client.patch(url, data)
        data = response.json()
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(data.get("name"), "testLesson1update")
...
class CourseTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.subscription = Subscription.objects.create(user=self.user, course=self.course, is_active=True)
        self.client.force_authenticate(user=self.user)
    ...
    def test_course_update(self):
        ...
        data = response.json()
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(data.get("name"), "testCourse1update")
